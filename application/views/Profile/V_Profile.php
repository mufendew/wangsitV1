		...
		<div class="section">
			<div class="row">
				...
				<div class="col l4 s12">
					<div class="card">
						<a href="<?php echo base_url()."Article/My/post"; ?>" class="<?php echo $belumAktivasibuttonDisable;?> btn btn-large" style="width: 100%;"><i class="material-icons right">add</i>Add Article</a>
					</div>
					<div class="card">
