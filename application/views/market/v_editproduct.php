	...
	<div class="ui middle aligned center aligned grid">
		...
		<div class="column-signup">
			...
			<h2 class="ui violet image header">
				...
				<div class="content">Wangsit Market Edit Product</div>

			</h2>

			<form method="post" action="<?php echo base_url(). 'market/c_admin/processupdateproduct/'.$product->product_id.'/'.$id_seller; ?>" class="ui large form">
				...
				<div class="ui stacked segment">
					...
					<div class="field">
						...
						<div class="ui left icon input">
							...
							<input type="text" name="newfullname" placeholder="Nama produk" value="<?php echo $product->product_name.'' ?>">
					...
					<div class="field">
						...
						<div class="ui left icon input">
							...
							<input type="text" name="newemail" placeholder="Deskripsi produk"
					...
					<div class="field">
						...
						<div class="ui left icon input">
							...
							<input type="number" name="newphone" placeholder="Harga produk"
					...
					<div class="ui fluid large violet submit button">Edit produk</div>
