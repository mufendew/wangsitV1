...
<head>
	...
	<title>Edit Profile | Wangsit Market</title>
	...
	<div class="ui middle aligned center aligned grid">
		...
		<div class="column-signup">
			...
			<h2 class="ui violet image header">
				...
				<div class="content">Wangsit Market Edit Profile</div>

			</h2>

			<form method="post" action="<?php echo base_url(). 'market/c_admin/processeditseller/'.$user->id; ?>" class="ui large form">
				...
				<div class="ui stacked segment">
					...
					<div class="field">
						...
						<div class="ui left icon input">
							...
							<input type="text" name="newfullname" placeholder="Nama" value="<?php echo $user->name ?>">
					...
					<div class="field">
						...
						<div class="ui labeled input">
							...
							<input type="text" name="newline" placeholder="LINE"

							value="<?php echo $user->line ?>">
					...
					<div class="field">
						...
						<div class="ui left icon input">
							...
							<input type="text" name="newinstagram" placeholder="Instagram"
					...
					<div class="field">
						...
						<div class="ui left icon input">
							...
							<input type="text" name="newwa" placeholder="Whatsapp"
					...
					<div class="field">
						...
						<div class="ui left icon input">
							...
							<input type="text" name="newhto" placeholder="How To Order"

							value="<?php echo $user->how_to_order ?>">
					...
					<div class="ui fluid large violet submit button">Edit Profile</div>
