...
class M_Article extends CI_Model {
	...
	{
		$query = $this->db->query("SELECT ID_ARTICLE, JUDUL, TANGGAL, CONTENT, USERNAME, DESKRIPSI, GAMBAR, NAMA, SHAREABLE  FROM article_article JOIN mhs_kbmsi on PENULIS = ID where SLUG='$slug' AND USERNAME = '$username'");
		return $query->row();
	}
